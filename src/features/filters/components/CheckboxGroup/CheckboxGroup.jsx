		...
		<div className="checkbox-group" role="group" aria-label={filterConfig.title}>
			{filterConfig.options.map((option) => (
				<div className="usa-checkbox checkbox-group__item">
					<input className="usa-checkbox__input usa-checkbox__input--tile checkbox-group__input" id={option.value} type="checkbox" value={option.value} checked={selectedValues.includes(option.value)} onChange={(e) => handleChange(option.value, e.target.checked)} aria-label={option.label} />
