...
describe('matchQueryParam', () => {
	it('matches a single code param to code type and array of single code', () => {
		const matchedParam = {
	...
	it('matches a list of code params to code type and array of codes', () => {
		const matchedParam = {
			paramType: queryParamType.code,
	...
	it('matches a pretty URL name param to purl type and string', () => {
		const matchedParam = {
	...
	it('matches a code,pretty URL name param to purl type and string', () => {
		const matchedParam = {
			paramType: queryParamType.purl,
